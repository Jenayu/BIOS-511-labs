...
/* Create adlb_1 dataset by adding variable LBSEQ and LBNRIND to adlb_0 dataset.
   ...
   The values of LBNRIND is derived using the LBSTRESN variable: gLh for low, gNh for normal, gHh for high; 
...
/* Create adlb_6 dataset by merging adlb_5 and adlb_4 
   ...
   which is set to the value of LBSTRESN and LBNRIND from the observation where LBBLFL = Y */
data adlb_6;
	merge adlb_5 adlb_4;
	by USUBJID LBTESTCD;
